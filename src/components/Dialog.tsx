...
export type DialogVariant = 'success' | 'error' | 'delete' | 'warning' | 'cancel' | 'save' | 'add';

const ICONS: Record<DialogVariant, () => JSX.Element> = {
...
export default function Dialog({ open, variant, title, message, onClose, actions, autoCloseMs }: DialogProps) {
  const { tv } = useApp();
