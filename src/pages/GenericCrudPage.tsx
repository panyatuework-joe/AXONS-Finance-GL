...
import type { CrudModuleConfig, Row } from '../types';
...
export default function GenericCrudPage({ config, data, onChange }: Props) {
  const { t, tv } = useApp();
  ...
  function handleSubmit() {
    ...
    if (modalMode === 'add') {
      const newRow: Row = { id: `${config.key}-${Date.now()}`, ...formValues };
